...
class CarController:
  def __init__(self, dbc_name, CP, VM):
    ...
    if CP.flags & SubaruFlags.SUBARU_SNG:
  ...
  def stop_and_go(self, CC: car.CarControl, CS: car.CarState, throttle_cmd: bool = False, speed_cmd: bool = False) -> tuple[bool, bool]:
    ...
    if self.CP.carFingerprint in PREGLOBAL_CARS:
      ...
      if (CC.enabled                                          # ACC active
        ...
        and CS.close_distance > SNG_ACC_MIN_DIST             # acc resume trigger low threshold
        and CS.close_distance < SNG_ACC_MAX_DIST             # acc resume trigger high threshold
